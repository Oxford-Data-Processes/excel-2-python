...
class ExcelCleaner:
    ...
    def _clean_formula(formula: str) -> str:
        ...
        formula = ExcelCleaner._remove_quotes(formula)
        formula = ExcelCleaner._remove_dollar_sign_from_excel_formula(formula)
        return formula
